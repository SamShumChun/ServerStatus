...
```
mkdir sss && cd sss && wget --no-check-certificate https://raw.githubusercontent.com/SamShumChun/ServerStatus/master/sss.sh && chmod +x ./sss.sh && sudo ./sss.sh YOUR_TG_CHAT_ID YOUR_TG_BOT_TOKEN
